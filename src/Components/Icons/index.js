const MessengerIcon = ({ className, width = '2.4rem', height = '2.4rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
const MailboxIcon = ({ className, width = '3.2rem', height = '3.2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export { MessengerIcon, MailboxIcon, SearchIcon };
